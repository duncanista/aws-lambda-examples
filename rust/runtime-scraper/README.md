...
Lambda Runtime Scraper is a Rust project that implements an AWS Lambda function in Rust which scrappes the [AWS Lambda runtimes page](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html) to check wheter a new runtime has changed.
